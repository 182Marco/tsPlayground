...
exports.getBackToCountriesAr = exports.agrCountries = exports.getAggregatedCountries3 = exports.getAggregatedCountries2 = exports.getAggregatedCountries = exports.middleEasternCountries = void 0;
exports.middleEasternCountries = [
    {
        name: 'Saudi Arabia',
        capital: 'Riyadh',
        population: 34813871,
...
const getAggregatedCountries = ar => {
    const aggregate = {};
    ar.forEach(c => {
        const { name, ...rest } = c;
        aggregate[name] = { ...rest };
...
const getAggregatedCountries2 = ar => {
    const aggregate = {};
    for (const c of ar) {
        const { name, ...rest } = c;
        aggregate[name] = { ...rest };
...
exports.getAggregatedCountries2 = getAggregatedCountries2;
const getAggregatedCountries3 = ar => ar.reduce((a, v) => {
    const { name, ...rest } = v;
    return { ...a, [name]: { ...rest } };
}, {});
exports.getAggregatedCountries3 = getAggregatedCountries3;
exports.agrCountries = (0, exports.getAggregatedCountries3)(exports.middleEasternCountries);
const getBackToCountriesAr = agr => Object.keys(agr).map(k => ({
    name: k,
    ...{ ...agr[k] },
}));
exports.getBackToCountriesAr = getBackToCountriesAr;
